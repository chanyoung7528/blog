  ...
  return (
    <div className="flex items-center gap-2">
      <button
        type="button"
        className={`
        bg-gray-100 hover:bg-gray-200 flex h-8
        cursor-pointer items-center justify-between gap-2
        whitespace-nowrap rounded-md bg-gray-4 px-2
        font-sans
      ...
      >
        ...
        <kbd
          ...
          inline-flex select-none items-center gap-1 rounded border bg-white
          px-1.5 py-0.5
          font-mono shadow-sm dark:bg-[#111]
        `}
        >
          {isMac ? "⌘" : "Ctrl"} K
        </kbd>
